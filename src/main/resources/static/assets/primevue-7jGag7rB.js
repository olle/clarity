...
`,rd={root:"p-overlaybadge"},id=T.extend({name:"overlaybadge",style:od,classes:rd}),ad={name:"OverlayBadge",extends:_t,style:id,provide:function(){return{$pcOverlayBadge:this,$parentInstance:this}}},sd={name:"OverlayBadge",extends:ad,inheritAttrs:!1,components:{Badge:_t}};function ld(e,t,n,o,r,i){var a=R("Badge");return v(),C("div",m({class:e.cx("root")},e.ptmi("root")),[_(e.$slots,"default"),ne(a,m(e.$props,{pt:e.ptm("pcBadge")}),null,16,["pt"])],16)}sd.render=ld;export{T as B,dd as H,cd as P,fd as T,Sr as U,K as a,io as b,me as c,Yu as d,Wa as e,Lo as f,un as g,ys as h,Q as i,Js as j,Pl as k,Xl as l,H as m,sd as n,md as o,A as s,pd as u};
